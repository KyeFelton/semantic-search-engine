...
\def\degree{B.Eng (Hons)}
\def\department{School of Electrical and Information Engineering \\ Faculty of Engineering}
\def\mydegrees{}

%\def\sid{460376785}

\def\supervisor{Yash Shrivastava}
\def\assocsupervisora{Joseph Davis}
\def\assocsupervisorb{Masoud Salehpour}
...
\hypersetup{
    pdfauthor = {Kye Felton},
    pdftitle = {Creating and Testing a Semantic SearchEngine for the University of Sydney},
    colorlinks,
%    linkcolor={blue},
%    citecolor={blue}
    linkcolor={black},
